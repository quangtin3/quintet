...
quintet.builder =
        {
                ...
                queryResult.sortable(
                        {
                            ...
                            {
                                if (!ui.helper)
                                    return; //Only do this for buttons
            ...
            init: function()
            {
                ...
                $(document).on('click', '.btn.stretch90', function(e) {
                    $(".fieldCategory").collapse('hide')
                });
                ...
                $('[id^="field."]').live('input', function(e) {
                    quintet.widget.applyOptions(e.srcElement);
                });
                $('[id^="field."]').live('change', function(e) {
                    quintet.widget.applyOptions(e.srcElement);
                }); //Enable the option option changing..
                ...
                $('[id^="form."]').live('input', function(e) {
                    quintet.widgets.form.applyOptions(e.srcElement);
                });
                $('[id^="form."]').live('change', function(e) {
                    quintet.widgets.form.applyOptions(e.srcElement);
                }); //Enable the option option changing..
